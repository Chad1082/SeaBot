...
namespace SeaBotCore.Cache
{
    ...
    internal static class DefenitionCache
    {
        ...
        private static readonly Dictionary<EDefinitionType, IDefinition> _cache =
            new Dictionary<EDefinitionType, IDefinition>();
        ...
        public static IDefinition GetDefinition(EDefinitionType type)
        {
            ...
            {
                case EDefinitionType.Barrels:
                    ret = JsonConvert.DeserializeObject<BarrelDefenitions.Root>(content);
                    break;
                case EDefinitionType.Boat:
                    ret = JsonConvert.DeserializeObject<BoatDefenitions.Root>(content);
                    break;
                case EDefinitionType.Buildings:
                    ret = JsonConvert.DeserializeObject<BuildingDefentions.Root>(content);
                    break;
                case EDefinitionType.Dealer:
                    ret = JsonConvert.DeserializeObject<DealerDefenitions.Root>(content);
                    break;
                case EDefinitionType.Wreck:
                    ret = JsonConvert.DeserializeObject<WreckDefinitions.Root>(content);
                    break;
                case EDefinitionType.Ship:
                    ret = JsonConvert.DeserializeObject<ShipDefenitions.Root>(content);
                    break;
                case EDefinitionType.Marketplace:
                    ret = JsonConvert.DeserializeObject<MarketplaceDefenitions.Root>(content);
                    break;
                case EDefinitionType.Upgradable:
                    ret = JsonConvert.DeserializeObject<UpgradeableDefenition.Root>(content);
                    break;
                case EDefinitionType.Events:
                    ret = JsonConvert.DeserializeObject<EventsDefenitions.Root>(content);
                    break;
                case EDefinitionType.Material:
